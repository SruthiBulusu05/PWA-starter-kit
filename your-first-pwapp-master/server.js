...
function generateFakeForecast(location) {
  ...
  var forecastObj=fakeForecast;
  if(location === "28.6472799,76.8130727"){
    forecastObj=fakeForecastDelhi;
  }
  const commaAt = location.indexOf(',');

  // Create a new copy of the forecast
  const result = Object.assign({}, forecastObj);
